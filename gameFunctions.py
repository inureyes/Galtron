...
        if item.rect.centerx -disX/1.7 < ship.rect.centerx < item.rect.centerx +disX/1.7 and item.rect.centery -disY/1.7 < ship.rect.centery < item.rect.centery +disY/1.7:
            if item.type == 1:
